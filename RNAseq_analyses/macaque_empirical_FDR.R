...
results=read.delim('MacaqueRawDEAnalysis2-2.txt', sep = " ")

#p-value permutations
GeomPolyTable <- read.delim("MacaqueempiricalPerm020223.txt")

#make table into wanted format
...
write.table(DEGenes, "MacaqueDEGenesEmpiricalFDR2-2.txt", quote=F)
